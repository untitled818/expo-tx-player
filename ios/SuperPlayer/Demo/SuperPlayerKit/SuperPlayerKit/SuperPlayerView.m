...
- (void)controlViewCase:(SuperPlayerControlView *)controlView {
    if ([self.delegate respondsToSelector:@selector(superPlayerCaseAction:)]) {
        [self.delegate superPlayerCaseAction:self];
    }
}
