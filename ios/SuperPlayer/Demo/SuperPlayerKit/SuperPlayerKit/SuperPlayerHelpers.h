...
// player singleton &player的单例
#define SuperPlayerShared [SuperPlayerSharedView sharedInstance]
// screen width &屏幕的宽
#define ScreenWidth [[UIScreen mainScreen] bounds].size.width
// screen height &屏幕的高
#define ScreenHeight [[UIScreen mainScreen] bounds].size.height
// color value RGB &颜色值RGB
#define RGBA(r, g, b, a) [UIColor colorWithRed:r / 255.0f green:g / 255.0f blue:b / 255.0f alpha:a]
// image path &图片路径
#define SuperPlayerImage(file) [UIImage imageNamed:file   inBundle:[NSBundle bundleWithPath:[[NSBundle mainBundle]    pathForResource:@"SuperPlayerKitBundle" ofType:@"bundle"]]   compatibleWithTraitCollection:nil]   

#define IsIPhoneX (ScreenHeight >= 812 || ScreenWidth >= 812)


// 小窗单例
#define SuperPlayerWindowShared [SuperPlayerSmallWindowManager sharedInstance]
#define SuperPlayerPIPShared [SuperPlayerPIPManager sharedInstance]
