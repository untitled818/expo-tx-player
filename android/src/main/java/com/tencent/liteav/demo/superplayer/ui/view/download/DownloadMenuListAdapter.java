...
public class DownloadMenuListAdapter extends RecyclerView.Adapter<DownloadMenuListAdapter.CacheMenuListHolder> {
  ...
  // `getDownloadMediaInfo` involves IO operations, and `mediaInfo` cannot be
  // obtained when downloading
  // just starts. Because real-time operation is not required here, the
  // `mediaInfo` is cached and stored,
