...
public class FloatPlayer extends AbsPlayer implements View.OnClickListener, VipWatchView.VipWatchViewClickListener {
  ...
  /**
   * Set click event listener to close the floating window after clicking the
   * close button.
   *
  ...
  public boolean onTouchEvent(MotionEvent event) {
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_UP:
        // If the finger does not slide, it is regarded as a click and returns to window
        // mode.
  ...
  /**
   * Update the position information of the floating window, and implement the
   * floating window movement in
