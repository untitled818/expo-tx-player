 ...
 * <p>
 * In addition to basic playback control, there are also gesture controls for
...
public class WindowPlayer extends AbsPlayer implements View.OnClickListener,
  ...
  /**
   * Override touch event listener to implement gesture control for adjusting
   * brightness,
